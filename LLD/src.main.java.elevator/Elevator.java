package LLD.src.main.java.elevator;
...
public class Elevator {
    ...
    public void sendUpRequest(Request upRequest) {
        ...
        if (upRequest.location == Location.OUTSIDE_ELEVATOR) {
            ...
            System.out.println("Append up request to go to floor from OUTSIDE at floor-" + upRequest.currentFloor + ".");
        }

        // Go to the desired floor
        upQueue.offer(upRequest);

        System.out.println("Append up request to go to floor from INSIDE to " + upRequest.desiredFloor + ".");
    }
    ...
    public void sendDownRequest(Request downRequest) {
        ...
        if (downRequest.location == Location.OUTSIDE_ELEVATOR) {
            ...
            System.out.println("Append down request to go to floor from OUTSIDE at floor-" + downRequest.currentFloor + ".");
        }

        // Go to the desired floor
        downQueue.offer(downRequest);

        System.out.println("Append down request to go to floor from INSIDE to-" + downRequest.desiredFloor + ".");
    }
